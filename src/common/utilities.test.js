...
test('percentile', () => {
    ...
    expect(Utility.percentile(numbers, 0.5)).toBe(2);
    expect(Utility.percentile(numbers, 0.25)).toBe(1);

    numbers = [3, 1, 2, 0];
    expect(Utility.percentile(numbers, 0.5)).toBe(1.5);
    expect(Utility.percentile(numbers, 0.25)).toBe(0.5);
})
